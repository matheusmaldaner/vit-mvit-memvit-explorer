  ...
  mvit: {
    ...
    stages: [
      ...
      },
      {
        ...
        note: 'The first stage stays dense to preserve motion and appearance detail across the clip. The visible 4 x 4 layout is a teaching simplification rather than an exact per-layer token count.',
        matrix: mvitStage1,
      ...
      },
      {
        ...
        note: 'Resolution drops while channel richness grows, making each token more semantic than before. The 3 x 3 view is a schematic stand-in for a much larger pooled representation.',
        matrix: mvitStage2,
